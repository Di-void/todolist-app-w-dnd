  ...
  return (
    <form className="px-4 py-2 mt-8 bg-elem-light flex items-center gap-x-3 rounded-md">
      ...
      <div className="rounded-full relative">
        <input
          type="checkbox"
          className="rounded-full border-none peer relative top-[-0.05rem] z-20 bg-transparent text-transparent focus:ring-2 focus:ring-offset-2 w-[25px] h-[25px] cursor-pointer"
        />
